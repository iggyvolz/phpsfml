...
$vectorOne = Vector2I::create($systemLib, 1, 2);
...
$vectorTwo = Vector2U::create($systemLib, 5, 6);
...
$vectorThree = Vector2F::create($systemLib, 9.0, 10.0);
...
$vectorFour = Vector3F::create($systemLib, 13.0, 14.0, 15.0);
