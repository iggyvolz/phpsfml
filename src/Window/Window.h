...
// `cpp -P -C -D "__attribute__(ARGS)=" -I. SFML/Window.h > Window.h` then removing comments
// This is done to remove all the "junk" that FFI can't process
// Also remove declarations from system.h, as they shouldn't be duplicated here
typedef int sfBool;
